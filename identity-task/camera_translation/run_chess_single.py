...
blender = "blender "
basecommand = "-b /data/Dropbox/17_18_ws/iccv_workshop/SimilarityChessGenTranslation/chessboard_single.blend -P /data/Dropbox/17_18_ws/iccv_workshop/SimilarityChessGenTranslation/chess_single.py -- "
baseimgdir = "/data/chessboard_data/similarity/"

for diff in args.diff:
    # Check if dir exists, otherwise create
    checkdir = "{}/trans_images_diff{}".format(baseimgdir, diff)
